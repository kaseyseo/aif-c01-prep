        ...
        <div className="min-h-screen bg-white pt-32 pb-24 font-['Inter',sans-serif]">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-10 space-y-6 shadow-sm">
                    ...
                    <ul className="space-y-4 text-slate-500 list-none px-0 font-['Roboto',sans-serif] text-[16px]">
                ...
                <div className="space-y-16">
                    ...
                    <div id="domain1" className="scroll-mt-24 space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="border-l-2 border-emerald-500 pl-4 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                        ...
                        <div className="grid gap-6">
                            <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-4 shadow-sm">
                                ...
                                <div className="space-y-4 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                            ...
                            <div className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 space-y-4 relative overflow-hidden shadow-sm">
                                <div className="absolute top-4 right-4"><span className="bg-emerald-50 text-emerald-700 border border-emerald-200 text-xs font-medium px-3 py-1 rounded-full">High Frequency</span></div>
                    ...
                    <div id="services" className="scroll-mt-24 space-y-8 pt-8">
                        <div className="space-y-4">
                            ...
                            <p className="border-l-2 border-emerald-500 pl-4 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={idx} className="bg-white border border-slate-200 hover:border-emerald-500/30 transition-colors rounded-2xl p-6 space-y-3 shadow-sm">
                        ...
                        <div className="mt-8 p-6 rounded-2xl bg-orange-50 border border-orange-200 text-orange-800 shadow-sm relative overflow-hidden">
