            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
                ...
                <div className="space-y-16">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-5 text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                            {[
                                ...
                                <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-6 text-center shadow-sm">
                                    <div className="text-3xl font-black text-emerald-500 mb-2">{stat.num}</div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <p className="text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">The exam contains one or more of the following question types:</p>
                            <ul className="space-y-5 text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">
                        ...
                        <div className="space-y-6 pt-4">
                            ...
                            <div className="p-6 rounded-xl bg-orange-50 border border-orange-200 text-orange-800 flex gap-4">
                                ...
                                <p className="font-['Inter',sans-serif] text-[16px]">Unanswered questions are scored as incorrect. There is no penalty for guessing, so always provide an answer even if you are unsure.</p>
                            </div>
                        </div>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <p className="text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">The AIF-C01 exam is divided into five content domains. Each domain carries a different percentage of the total scored content. Understanding which domains carry the most weight allows you to prioritise your study time effectively.</p>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left border-collapse border-b border-slate-200">
                                ...
                                <tbody className="text-slate-500 font-['Roboto',sans-serif] divide-y divide-slate-200">
                                    {[
                                        ...
                                        <tr key={idx} className="hover:bg-slate-50 transition-colors">
                                            <td className="py-4 px-6 whitespace-nowrap">
                                                <span className="bg-emerald-50 text-emerald-700 text-xs font-medium px-3 py-1.5 rounded-md border border-emerald-100">{domain.id}</span>
                                            </td>
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="space-y-4 text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <div className="space-y-6 text-slate-500 font-['Roboto',sans-serif] leading-relaxed text-[16px]">
