...
export default function StudyTipsPage() {
    return (
        <div className="min-h-screen bg-white pt-32 pb-24 font-['Inter',sans-serif]">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-24">
                ...
                <div className="text-center space-y-4">
                    ...
                    <p className="text-slate-500 text-lg mx-auto font-['Inter',sans-serif] leading-relaxed">
                ...
                <div className="space-y-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-5 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-500 text-lg font-['Roboto',sans-serif]">This schedule assumes you can study for 1 to 2 hours per day. Adjust the pace based on your existing background knowledge.</p>
                            ...
                            {[
                                ...
                                <div key={idx} className={`flex flex-col sm:flex-row bg-white ${idx !== arr.length - 1 ? 'border-b border-slate-200' : ''}`}>
                                    <div className="sm:w-32 shrink-0 px-6 py-5 flex items-center">
                                        <div className="bg-emerald-50 text-emerald-700 border border-emerald-200 font-medium text-[12px] px-2.5 py-1 rounded">
                                            {item.week}
                                        </div>
                                    </div>
                                    <div className="flex-1 px-6 py-5 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                                        {item.content}
                                    </div>
                                </div>
                            ))}
                            ...
                            {[
                                ...
                                <div key={idx} className="bg-white border border-slate-200 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row gap-6 shadow-sm">
                                    <div className="shrink-0">
                                        <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-emerald-50 border border-emerald-200 text-emerald-700 font-bold text-2xl">
                                            {step.num}
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <h3 className="text-[20px] font-bold text-slate-900">{step.title}</h3>
                                        <p className="text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">{step.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                        ...
                        <div className="space-y-6 pt-2">
                            ...
                            <div className="border-l-2 border-emerald-500 pl-6 space-y-3">
                                ...
                                <div className="space-y-3 text-slate-500 text-[16px] font-['Roboto',sans-serif] leading-relaxed">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            ...
                            <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-6 sm:p-8 space-y-6">
                                <h3 className="text-[20px] font-bold text-emerald-700 flex items-center justify-center sm:justify-start gap-2">
                                    Do This
                                </h3>
                                <ul className="space-y-4 text-slate-500 text-[16px] font-['Roboto',sans-serif]">
                                    <li className="flex gap-3">
                                        <svg className="w-5 h-5 text-emerald-700 shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"></path></svg>
