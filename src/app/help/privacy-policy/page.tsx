        ...
        <div className="min-h-screen bg-white pt-24 pb-24 font-['Inter',sans-serif]">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
                ...
                <div className="bg-white border border-slate-200 rounded-3xl p-8 sm:p-12 space-y-10 shadow-sm">
                    <div className="text-emerald-800 font-medium bg-emerald-50 inline-block px-4 py-2 rounded-lg border border-emerald-200 text-[14px]">
                    ...
                    <div className="space-y-3 text-slate-500 leading-relaxed font-['Roboto',sans-serif]">
                        ...
                        <p className="text-[16px]">You may opt out of personalised advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-500 font-medium underline">Google's Ads Settings</a>. Alternatively, you can opt out of third-party vendor use of cookies for personalised advertising by visiting <a href="http://www.aboutads.info/choices/" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-500 font-medium underline">www.aboutads.info/choices</a>.</p>
                        <p className="text-[16px]">For more information on how Google collects and processes data, please see Google's Privacy Policy at <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-500 font-medium underline">policies.google.com/privacy</a>.</p>
                    </div>

                    <div className="space-y-3 text-slate-500 leading-relaxed font-['Roboto',sans-serif]">
                        <h2 className="tracking-tight text-[24px] font-bold text-slate-900 mb-2">5. Google Analytics</h2>
                        <p className="text-[16px]">We may use Google Analytics to analyse the use of our website. Google Analytics gathers information about website use by means of cookies. The information gathered is used to create reports about the use of our website. Google's privacy policy is available at <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-500 font-medium underline">policies.google.com/privacy</a>.</p>
                        <p className="text-[16px]">You can opt out of Google Analytics tracking by installing the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:text-emerald-500 font-medium underline">Google Analytics Opt-out Browser Add-on</a>.</p>
                    </div>
                    ...
                    <div className="pt-8 border-t border-slate-200 text-[14px] text-slate-400 text-center font-['Roboto',sans-serif]">
